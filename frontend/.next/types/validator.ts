...
// Validate ../../app/api/auth/jwt/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/auth/jwt">> = Specific
  const handler = {} as typeof import("../../app/api/auth/jwt/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
